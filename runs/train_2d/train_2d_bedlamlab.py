...
CUR_PATH = os.getcwd()
@hydra.main(version_base=None, config_path=os.path.join(CUR_PATH, "configs/train/models_2d"), config_name="config_bedlamlab2d.yaml")
def main(cfg: DictConfig):
    ...
    work_dir = osp.join(CUR_PATH, cfg.work_dir, 'train', 'bedlamlab_2d', exp_name)
    ...
    bedlam_exp_name = exp_name.replace("_" + timestamp, "")
