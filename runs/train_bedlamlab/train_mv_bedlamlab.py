...
CUR_PATH = os.getcwd()
@hydra.main(version_base=None, config_path=os.path.join(CUR_PATH, "configs/train/models_2d"), config_name="config_bedlamlab_mv.yaml")
def main(cfg: DictConfig):
    ...
    work_dir = osp.join(CUR_PATH, cfg.work_dir, 'train', 'bedlamlab_mv', "debug" if cfg.debug_mode else exp_name)
    ...
    bedlam_exp_name = exp_name.replace("_" + timestamp, "").replace("pose_multiview", "pose_detr")
